...
pattern SDL_GPU_PRIMITIVETYPE_TRIANGLESTRIP = SDLGPUPrimitiveType #{const SDL_GPU_PRIMITIVETYPE_TRIANGLESTRIP}
pattern SDL_GPU_PRIMITIVETYPE_LINELIST :: SDLGPUPrimitiveType
pattern SDL_GPU_PRIMITIVETYPE_LINELIST = SDLGPUPrimitiveType #{const SDL_GPU_PRIMITIVETYPE_LINELIST}
pattern SDL_GPU_PRIMITIVETYPE_LINESTRIP :: SDLGPUPrimitiveType
pattern SDL_GPU_PRIMITIVETYPE_LINESTRIP = SDLGPUPrimitiveType #{const SDL_GPU_PRIMITIVETYPE_LINESTRIP}
...
pattern SDL_GPU_LOADOP_CLEAR = SDLGPULoadOp #{const SDL_GPU_LOADOP_CLEAR}
...
pattern SDL_GPU_STOREOP_DONT_CARE = SDLGPUStoreOp #{const SDL_GPU_STOREOP_DONT_CARE}
pattern SDL_GPU_STOREOP_RESOLVE :: SDLGPUStoreOp
pattern SDL_GPU_STOREOP_RESOLVE = SDLGPUStoreOp #{const SDL_GPU_STOREOP_RESOLVE}
...
pattern SDL_GPU_TEXTUREFORMAT_A8_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_A8_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_R8_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R8_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R8_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_R8G8_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R8G8_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R8G8_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_R8G8B8A8_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R8G8B8A8_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R8G8B8A8_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_R16_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R16_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R16_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_R16G16_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R16G16_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R16G16_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_R16G16B16A16_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R16G16B16A16_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R16G16B16A16_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_R10G10B10A2_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R10G10B10A2_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R10G10B10A2_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_B5G6R5_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_B5G6R5_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_B5G6R5_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_B5G5R5A1_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_B5G5R5A1_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_B5G5R5A1_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_B4G4R4A4_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_B4G4R4A4_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_B4G4R4A4_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_B8G8R8A8_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_B8G8R8A8_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_B8G8R8A8_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_BC1_RGBA_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_BC1_RGBA_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_BC1_RGBA_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_BC2_RGBA_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_BC2_RGBA_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_BC2_RGBA_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_BC3_RGBA_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_BC3_RGBA_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_BC3_RGBA_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_BC4_R_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_BC4_R_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_BC4_R_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_BC5_RG_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_BC5_RG_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_BC5_RG_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_BC7_RGBA_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_BC7_RGBA_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_BC7_RGBA_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_BC6H_RGB_FLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_BC6H_RGB_FLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_BC6H_RGB_FLOAT}
pattern SDL_GPU_TEXTUREFORMAT_BC6H_RGB_UFLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_BC6H_RGB_UFLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_BC6H_RGB_UFLOAT}
pattern SDL_GPU_TEXTUREFORMAT_R8_SNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R8_SNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R8_SNORM}
pattern SDL_GPU_TEXTUREFORMAT_R8G8_SNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R8G8_SNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R8G8_SNORM}
pattern SDL_GPU_TEXTUREFORMAT_R8G8B8A8_SNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R8G8B8A8_SNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R8G8B8A8_SNORM}
pattern SDL_GPU_TEXTUREFORMAT_R16_SNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R16_SNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R16_SNORM}
pattern SDL_GPU_TEXTUREFORMAT_R16G16_SNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R16G16_SNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R16G16_SNORM}
pattern SDL_GPU_TEXTUREFORMAT_R16G16B16A16_SNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R16G16B16A16_SNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R16G16B16A16_SNORM}
pattern SDL_GPU_TEXTUREFORMAT_R16_FLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R16_FLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R16_FLOAT}
pattern SDL_GPU_TEXTUREFORMAT_R16G16_FLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R16G16_FLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R16G16_FLOAT}
pattern SDL_GPU_TEXTUREFORMAT_R16G16B16A16_FLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R16G16B16A16_FLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R16G16B16A16_FLOAT}
pattern SDL_GPU_TEXTUREFORMAT_R32_FLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R32_FLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R32_FLOAT}
pattern SDL_GPU_TEXTUREFORMAT_R32G32_FLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R32G32_FLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R32G32_FLOAT}
pattern SDL_GPU_TEXTUREFORMAT_R32G32B32A32_FLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R32G32B32A32_FLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R32G32B32A32_FLOAT}
pattern SDL_GPU_TEXTUREFORMAT_R11G11B10_UFLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R11G11B10_UFLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R11G11B10_UFLOAT}
pattern SDL_GPU_TEXTUREFORMAT_R8_UINT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R8_UINT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R8_UINT}
pattern SDL_GPU_TEXTUREFORMAT_R8G8_UINT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R8G8_UINT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R8G8_UINT}
pattern SDL_GPU_TEXTUREFORMAT_R8G8B8A8_UINT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R8G8B8A8_UINT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R8G8B8A8_UINT}
pattern SDL_GPU_TEXTUREFORMAT_R16_UINT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R16_UINT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R16_UINT}
pattern SDL_GPU_TEXTUREFORMAT_R16G16_UINT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R16G16_UINT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R16G16_UINT}
pattern SDL_GPU_TEXTUREFORMAT_R16G16B16A16_UINT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R16G16B16A16_UINT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R16G16B16A16_UINT}
pattern SDL_GPU_TEXTUREFORMAT_R32_UINT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R32_UINT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R32_UINT}
pattern SDL_GPU_TEXTUREFORMAT_R32G32_UINT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R32G32_UINT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R32G32_UINT}
pattern SDL_GPU_TEXTUREFORMAT_R32G32B32A32_UINT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R32G32B32A32_UINT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R32G32B32A32_UINT}
pattern SDL_GPU_TEXTUREFORMAT_R8_INT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R8_INT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R8_INT}
pattern SDL_GPU_TEXTUREFORMAT_R8G8_INT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R8G8_INT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R8G8_INT}
pattern SDL_GPU_TEXTUREFORMAT_R8G8B8A8_INT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R8G8B8A8_INT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R8G8B8A8_INT}
pattern SDL_GPU_TEXTUREFORMAT_R16_INT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R16_INT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R16_INT}
pattern SDL_GPU_TEXTUREFORMAT_R16G16_INT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R16G16_INT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R16G16_INT}
pattern SDL_GPU_TEXTUREFORMAT_R16G16B16A16_INT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R16G16B16A16_INT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R16G16B16A16_INT}
pattern SDL_GPU_TEXTUREFORMAT_R32_INT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R32_INT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R32_INT}
pattern SDL_GPU_TEXTUREFORMAT_R32G32_INT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R32G32_INT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R32G32_INT}
pattern SDL_GPU_TEXTUREFORMAT_R32G32B32A32_INT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R32G32B32A32_INT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R32G32B32A32_INT}
pattern SDL_GPU_TEXTUREFORMAT_R8G8B8A8_UNORM_SRGB :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_R8G8B8A8_UNORM_SRGB = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_R8G8B8A8_UNORM_SRGB}
pattern SDL_GPU_TEXTUREFORMAT_B8G8R8A8_UNORM_SRGB :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_B8G8R8A8_UNORM_SRGB = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_B8G8R8A8_UNORM_SRGB}
pattern SDL_GPU_TEXTUREFORMAT_BC1_RGBA_UNORM_SRGB :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_BC1_RGBA_UNORM_SRGB = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_BC1_RGBA_UNORM_SRGB}
pattern SDL_GPU_TEXTUREFORMAT_BC2_RGBA_UNORM_SRGB :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_BC2_RGBA_UNORM_SRGB = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_BC2_RGBA_UNORM_SRGB}
pattern SDL_GPU_TEXTUREFORMAT_BC3_RGBA_UNORM_SRGB :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_BC3_RGBA_UNORM_SRGB = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_BC3_RGBA_UNORM_SRGB}
pattern SDL_GPU_TEXTUREFORMAT_BC7_RGBA_UNORM_SRGB :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_BC7_RGBA_UNORM_SRGB = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_BC7_RGBA_UNORM_SRGB}
pattern SDL_GPU_TEXTUREFORMAT_D16_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_D16_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_D16_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_D24_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_D24_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_D24_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_D32_FLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_D32_FLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_D32_FLOAT}
pattern SDL_GPU_TEXTUREFORMAT_D24_UNORM_S8_UINT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_D24_UNORM_S8_UINT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_D24_UNORM_S8_UINT}
pattern SDL_GPU_TEXTUREFORMAT_D32_FLOAT_S8_UINT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_D32_FLOAT_S8_UINT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_D32_FLOAT_S8_UINT}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_4x4_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_4x4_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_4x4_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_5x4_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_5x4_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_5x4_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_5x5_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_5x5_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_5x5_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_6x5_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_6x5_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_6x5_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_6x6_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_6x6_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_6x6_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_8x5_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_8x5_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_8x5_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_8x6_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_8x6_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_8x6_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_8x8_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_8x8_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_8x8_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x5_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x5_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_10x5_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x6_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x6_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_10x6_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x8_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x8_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_10x8_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x10_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x10_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_10x10_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_12x10_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_12x10_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_12x10_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_12x12_UNORM :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_12x12_UNORM = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_12x12_UNORM}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_4x4_UNORM_SRGB :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_4x4_UNORM_SRGB = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_4x4_UNORM_SRGB}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_5x4_UNORM_SRGB :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_5x4_UNORM_SRGB = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_5x4_UNORM_SRGB}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_5x5_UNORM_SRGB :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_5x5_UNORM_SRGB = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_5x5_UNORM_SRGB}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_6x5_UNORM_SRGB :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_6x5_UNORM_SRGB = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_6x5_UNORM_SRGB}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_6x6_UNORM_SRGB :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_6x6_UNORM_SRGB = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_6x6_UNORM_SRGB}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_8x5_UNORM_SRGB :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_8x5_UNORM_SRGB = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_8x5_UNORM_SRGB}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_8x6_UNORM_SRGB :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_8x6_UNORM_SRGB = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_8x6_UNORM_SRGB}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_8x8_UNORM_SRGB :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_8x8_UNORM_SRGB = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_8x8_UNORM_SRGB}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x5_UNORM_SRGB :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x5_UNORM_SRGB = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_10x5_UNORM_SRGB}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x6_UNORM_SRGB :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x6_UNORM_SRGB = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_10x6_UNORM_SRGB}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x8_UNORM_SRGB :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x8_UNORM_SRGB = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_10x8_UNORM_SRGB}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x10_UNORM_SRGB :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x10_UNORM_SRGB = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_10x10_UNORM_SRGB}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_12x10_UNORM_SRGB :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_12x10_UNORM_SRGB = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_12x10_UNORM_SRGB}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_12x12_UNORM_SRGB :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_12x12_UNORM_SRGB = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_12x12_UNORM_SRGB}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_4x4_FLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_4x4_FLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_4x4_FLOAT}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_5x4_FLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_5x4_FLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_5x4_FLOAT}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_5x5_FLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_5x5_FLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_5x5_FLOAT}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_6x5_FLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_6x5_FLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_6x5_FLOAT}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_6x6_FLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_6x6_FLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_6x6_FLOAT}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_8x5_FLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_8x5_FLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_8x5_FLOAT}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_8x6_FLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_8x6_FLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_8x6_FLOAT}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_8x8_FLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_8x8_FLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_8x8_FLOAT}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x5_FLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x5_FLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_10x5_FLOAT}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x6_FLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x6_FLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_10x6_FLOAT}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x8_FLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x8_FLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_10x8_FLOAT}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x10_FLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_10x10_FLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_10x10_FLOAT}
pattern SDL_GPU_TEXTUREFORMAT_ASTC_12x10_FLOAT :: SDLGPUTextureFormat
pattern SDL_GPU_TEXTUREFORMAT_ASTC_12x10_FLOAT = SDLGPUTextureFormat #{const SDL_GPU_TEXTUREFORMAT_ASTC_12x10_FLOAT}
...
pattern SDL_GPU_TEXTURETYPE_2D_ARRAY = SDLGPUTextureType #{const SDL_GPU_TEXTURETYPE_2D_ARRAY}
pattern SDL_GPU_TEXTURETYPE_3D :: SDLGPUTextureType
pattern SDL_GPU_TEXTURETYPE_3D = SDLGPUTextureType #{const SDL_GPU_TEXTURETYPE_3D}
pattern SDL_GPU_TEXTURETYPE_CUBE :: SDLGPUTextureType
pattern SDL_GPU_TEXTURETYPE_CUBE = SDLGPUTextureType #{const SDL_GPU_TEXTURETYPE_CUBE}
...
pattern SDL_GPU_SAMPLECOUNT_2 = SDLGPUSampleCount #{const SDL_GPU_SAMPLECOUNT_2}
pattern SDL_GPU_SAMPLECOUNT_4 :: SDLGPUSampleCount
pattern SDL_GPU_SAMPLECOUNT_4 = SDLGPUSampleCount #{const SDL_GPU_SAMPLECOUNT_4}
...
pattern SDL_GPU_CUBEMAPFACE_NEGATIVEX = SDLGPUCubeMapFace #{const SDL_GPU_CUBEMAPFACE_NEGATIVEX}
pattern SDL_GPU_CUBEMAPFACE_POSITIVEY :: SDLGPUCubeMapFace
pattern SDL_GPU_CUBEMAPFACE_POSITIVEY = SDLGPUCubeMapFace #{const SDL_GPU_CUBEMAPFACE_POSITIVEY}
pattern SDL_GPU_CUBEMAPFACE_NEGATIVEY :: SDLGPUCubeMapFace
pattern SDL_GPU_CUBEMAPFACE_NEGATIVEY = SDLGPUCubeMapFace #{const SDL_GPU_CUBEMAPFACE_NEGATIVEY}
pattern SDL_GPU_CUBEMAPFACE_POSITIVEZ :: SDLGPUCubeMapFace
pattern SDL_GPU_CUBEMAPFACE_POSITIVEZ = SDLGPUCubeMapFace #{const SDL_GPU_CUBEMAPFACE_POSITIVEZ}
...
pattern SDL_GPU_VERTEXELEMENTFORMAT_INT = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_INT}
pattern SDL_GPU_VERTEXELEMENTFORMAT_INT2 :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_INT2 = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_INT2}
pattern SDL_GPU_VERTEXELEMENTFORMAT_INT3 :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_INT3 = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_INT3}
pattern SDL_GPU_VERTEXELEMENTFORMAT_INT4 :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_INT4 = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_INT4}
pattern SDL_GPU_VERTEXELEMENTFORMAT_UINT :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_UINT = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_UINT}
pattern SDL_GPU_VERTEXELEMENTFORMAT_UINT2 :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_UINT2 = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_UINT2}
pattern SDL_GPU_VERTEXELEMENTFORMAT_UINT3 :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_UINT3 = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_UINT3}
pattern SDL_GPU_VERTEXELEMENTFORMAT_UINT4 :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_UINT4 = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_UINT4}
pattern SDL_GPU_VERTEXELEMENTFORMAT_FLOAT :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_FLOAT = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_FLOAT}
pattern SDL_GPU_VERTEXELEMENTFORMAT_FLOAT2 :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_FLOAT2 = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_FLOAT2}
pattern SDL_GPU_VERTEXELEMENTFORMAT_FLOAT3 :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_FLOAT3 = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_FLOAT3}
pattern SDL_GPU_VERTEXELEMENTFORMAT_FLOAT4 :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_FLOAT4 = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_FLOAT4}
pattern SDL_GPU_VERTEXELEMENTFORMAT_BYTE2 :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_BYTE2 = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_BYTE2}
pattern SDL_GPU_VERTEXELEMENTFORMAT_BYTE4 :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_BYTE4 = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_BYTE4}
pattern SDL_GPU_VERTEXELEMENTFORMAT_UBYTE2 :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_UBYTE2 = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_UBYTE2}
pattern SDL_GPU_VERTEXELEMENTFORMAT_UBYTE4 :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_UBYTE4 = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_UBYTE4}
pattern SDL_GPU_VERTEXELEMENTFORMAT_BYTE2_NORM :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_BYTE2_NORM = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_BYTE2_NORM}
pattern SDL_GPU_VERTEXELEMENTFORMAT_BYTE4_NORM :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_BYTE4_NORM = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_BYTE4_NORM}
pattern SDL_GPU_VERTEXELEMENTFORMAT_UBYTE2_NORM :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_UBYTE2_NORM = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_UBYTE2_NORM}
pattern SDL_GPU_VERTEXELEMENTFORMAT_UBYTE4_NORM :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_UBYTE4_NORM = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_UBYTE4_NORM}
pattern SDL_GPU_VERTEXELEMENTFORMAT_SHORT2 :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_SHORT2 = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_SHORT2}
pattern SDL_GPU_VERTEXELEMENTFORMAT_SHORT4 :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_SHORT4 = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_SHORT4}
pattern SDL_GPU_VERTEXELEMENTFORMAT_USHORT2 :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_USHORT2 = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_USHORT2}
pattern SDL_GPU_VERTEXELEMENTFORMAT_USHORT4 :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_USHORT4 = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_USHORT4}
pattern SDL_GPU_VERTEXELEMENTFORMAT_SHORT2_NORM :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_SHORT2_NORM = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_SHORT2_NORM}
pattern SDL_GPU_VERTEXELEMENTFORMAT_SHORT4_NORM :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_SHORT4_NORM = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_SHORT4_NORM}
pattern SDL_GPU_VERTEXELEMENTFORMAT_USHORT2_NORM :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_USHORT2_NORM = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_USHORT2_NORM}
pattern SDL_GPU_VERTEXELEMENTFORMAT_USHORT4_NORM :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_USHORT4_NORM = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_USHORT4_NORM}
pattern SDL_GPU_VERTEXELEMENTFORMAT_HALF2 :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_HALF2 = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_HALF2}
pattern SDL_GPU_VERTEXELEMENTFORMAT_HALF4 :: SDLGPUVertexElementFormat
pattern SDL_GPU_VERTEXELEMENTFORMAT_HALF4 = SDLGPUVertexElementFormat #{const SDL_GPU_VERTEXELEMENTFORMAT_HALF4}

newtype SDLGPUVertexInputRate = SDLGPUVertexInputRate CInt deriving (Show, Eq, Storable)
pattern SDL_GPU_VERTEXINPUTRATE_VERTEX :: SDLGPUVertexInputRate
pattern SDL_GPU_VERTEXINPUTRATE_VERTEX = SDLGPUVertexInputRate #{const SDL_GPU_VERTEXINPUTRATE_VERTEX}
...
pattern SDL_GPU_CULLMODE_FRONT = SDLGPUCullMode #{const SDL_GPU_CULLMODE_FRONT}
...
pattern SDL_GPU_COMPAREOP_NEVER = SDLGPUCompareOp #{const SDL_GPU_COMPAREOP_NEVER}
pattern SDL_GPU_COMPAREOP_LESS :: SDLGPUCompareOp
pattern SDL_GPU_COMPAREOP_LESS = SDLGPUCompareOp #{const SDL_GPU_COMPAREOP_LESS}
pattern SDL_GPU_COMPAREOP_EQUAL :: SDLGPUCompareOp
pattern SDL_GPU_COMPAREOP_EQUAL = SDLGPUCompareOp #{const SDL_GPU_COMPAREOP_EQUAL}
pattern SDL_GPU_COMPAREOP_LESS_OR_EQUAL :: SDLGPUCompareOp
pattern SDL_GPU_COMPAREOP_LESS_OR_EQUAL = SDLGPUCompareOp #{const SDL_GPU_COMPAREOP_LESS_OR_EQUAL}
pattern SDL_GPU_COMPAREOP_GREATER :: SDLGPUCompareOp
pattern SDL_GPU_COMPAREOP_GREATER = SDLGPUCompareOp #{const SDL_GPU_COMPAREOP_GREATER}
pattern SDL_GPU_COMPAREOP_NOT_EQUAL :: SDLGPUCompareOp
pattern SDL_GPU_COMPAREOP_NOT_EQUAL = SDLGPUCompareOp #{const SDL_GPU_COMPAREOP_NOT_EQUAL}
pattern SDL_GPU_COMPAREOP_GREATER_OR_EQUAL :: SDLGPUCompareOp
pattern SDL_GPU_COMPAREOP_GREATER_OR_EQUAL = SDLGPUCompareOp #{const SDL_GPU_COMPAREOP_GREATER_OR_EQUAL}
...
pattern SDL_GPU_STENCILOP_KEEP = SDLGPUStencilOp #{const SDL_GPU_STENCILOP_KEEP}
pattern SDL_GPU_STENCILOP_ZERO :: SDLGPUStencilOp
pattern SDL_GPU_STENCILOP_ZERO = SDLGPUStencilOp #{const SDL_GPU_STENCILOP_ZERO}
pattern SDL_GPU_STENCILOP_REPLACE :: SDLGPUStencilOp
pattern SDL_GPU_STENCILOP_REPLACE = SDLGPUStencilOp #{const SDL_GPU_STENCILOP_REPLACE}
pattern SDL_GPU_STENCILOP_INCREMENT_AND_CLAMP :: SDLGPUStencilOp
pattern SDL_GPU_STENCILOP_INCREMENT_AND_CLAMP = SDLGPUStencilOp #{const SDL_GPU_STENCILOP_INCREMENT_AND_CLAMP}
pattern SDL_GPU_STENCILOP_DECREMENT_AND_CLAMP :: SDLGPUStencilOp
pattern SDL_GPU_STENCILOP_DECREMENT_AND_CLAMP = SDLGPUStencilOp #{const SDL_GPU_STENCILOP_DECREMENT_AND_CLAMP}
pattern SDL_GPU_STENCILOP_INVERT :: SDLGPUStencilOp
pattern SDL_GPU_STENCILOP_INVERT = SDLGPUStencilOp #{const SDL_GPU_STENCILOP_INVERT}
pattern SDL_GPU_STENCILOP_INCREMENT_AND_WRAP :: SDLGPUStencilOp
pattern SDL_GPU_STENCILOP_INCREMENT_AND_WRAP = SDLGPUStencilOp #{const SDL_GPU_STENCILOP_INCREMENT_AND_WRAP}
...
pattern SDL_GPU_BLENDOP_ADD = SDLGPUBlendOp #{const SDL_GPU_BLENDOP_ADD}
pattern SDL_GPU_BLENDOP_SUBTRACT :: SDLGPUBlendOp
pattern SDL_GPU_BLENDOP_SUBTRACT = SDLGPUBlendOp #{const SDL_GPU_BLENDOP_SUBTRACT}
pattern SDL_GPU_BLENDOP_REVERSE_SUBTRACT :: SDLGPUBlendOp
pattern SDL_GPU_BLENDOP_REVERSE_SUBTRACT = SDLGPUBlendOp #{const SDL_GPU_BLENDOP_REVERSE_SUBTRACT}
pattern SDL_GPU_BLENDOP_MIN :: SDLGPUBlendOp
pattern SDL_GPU_BLENDOP_MIN = SDLGPUBlendOp #{const SDL_GPU_BLENDOP_MIN}
...
pattern SDL_GPU_BLENDFACTOR_ZERO = SDLGPUBlendFactor #{const SDL_GPU_BLENDFACTOR_ZERO}
pattern SDL_GPU_BLENDFACTOR_ONE :: SDLGPUBlendFactor
pattern SDL_GPU_BLENDFACTOR_ONE = SDLGPUBlendFactor #{const SDL_GPU_BLENDFACTOR_ONE}
pattern SDL_GPU_BLENDFACTOR_SRC_COLOR :: SDLGPUBlendFactor
pattern SDL_GPU_BLENDFACTOR_SRC_COLOR = SDLGPUBlendFactor #{const SDL_GPU_BLENDFACTOR_SRC_COLOR}
pattern SDL_GPU_BLENDFACTOR_ONE_MINUS_SRC_COLOR :: SDLGPUBlendFactor
pattern SDL_GPU_BLENDFACTOR_ONE_MINUS_SRC_COLOR = SDLGPUBlendFactor #{const SDL_GPU_BLENDFACTOR_ONE_MINUS_SRC_COLOR}
pattern SDL_GPU_BLENDFACTOR_DST_COLOR :: SDLGPUBlendFactor
pattern SDL_GPU_BLENDFACTOR_DST_COLOR = SDLGPUBlendFactor #{const SDL_GPU_BLENDFACTOR_DST_COLOR}
pattern SDL_GPU_BLENDFACTOR_ONE_MINUS_DST_COLOR :: SDLGPUBlendFactor
pattern SDL_GPU_BLENDFACTOR_ONE_MINUS_DST_COLOR = SDLGPUBlendFactor #{const SDL_GPU_BLENDFACTOR_ONE_MINUS_DST_COLOR}
pattern SDL_GPU_BLENDFACTOR_SRC_ALPHA :: SDLGPUBlendFactor
pattern SDL_GPU_BLENDFACTOR_SRC_ALPHA = SDLGPUBlendFactor #{const SDL_GPU_BLENDFACTOR_SRC_ALPHA}
pattern SDL_GPU_BLENDFACTOR_ONE_MINUS_SRC_ALPHA :: SDLGPUBlendFactor
pattern SDL_GPU_BLENDFACTOR_ONE_MINUS_SRC_ALPHA = SDLGPUBlendFactor #{const SDL_GPU_BLENDFACTOR_ONE_MINUS_SRC_ALPHA}
pattern SDL_GPU_BLENDFACTOR_DST_ALPHA :: SDLGPUBlendFactor
pattern SDL_GPU_BLENDFACTOR_DST_ALPHA = SDLGPUBlendFactor #{const SDL_GPU_BLENDFACTOR_DST_ALPHA}
pattern SDL_GPU_BLENDFACTOR_ONE_MINUS_DST_ALPHA :: SDLGPUBlendFactor
pattern SDL_GPU_BLENDFACTOR_ONE_MINUS_DST_ALPHA = SDLGPUBlendFactor #{const SDL_GPU_BLENDFACTOR_ONE_MINUS_DST_ALPHA}
pattern SDL_GPU_BLENDFACTOR_CONSTANT_COLOR :: SDLGPUBlendFactor
pattern SDL_GPU_BLENDFACTOR_CONSTANT_COLOR = SDLGPUBlendFactor #{const SDL_GPU_BLENDFACTOR_CONSTANT_COLOR}
pattern SDL_GPU_BLENDFACTOR_ONE_MINUS_CONSTANT_COLOR :: SDLGPUBlendFactor
pattern SDL_GPU_BLENDFACTOR_ONE_MINUS_CONSTANT_COLOR = SDLGPUBlendFactor #{const SDL_GPU_BLENDFACTOR_ONE_MINUS_CONSTANT_COLOR}
...
pattern SDL_GPU_SAMPLERADDRESSMODE_MIRRORED_REPEAT = SDLGPUSamplerAddressMode #{const SDL_GPU_SAMPLERADDRESSMODE_MIRRORED_REPEAT}
...
pattern SDL_GPU_PRESENTMODE_IMMEDIATE = SDLGPUPresentMode #{const SDL_GPU_PRESENTMODE_IMMEDIATE}
...
pattern SDL_GPU_SWAPCHAINCOMPOSITION_SDR_LINEAR = SDLGPUSwapchainComposition #{const SDL_GPU_SWAPCHAINCOMPOSITION_SDR_LINEAR}
pattern SDL_GPU_SWAPCHAINCOMPOSITION_HDR_EXTENDED_LINEAR :: SDLGPUSwapchainComposition
pattern SDL_GPU_SWAPCHAINCOMPOSITION_HDR_EXTENDED_LINEAR = SDLGPUSwapchainComposition #{const SDL_GPU_SWAPCHAINCOMPOSITION_HDR_EXTENDED_LINEAR}
pattern SDL_GPU_SWAPCHAINCOMPOSITION_HDR10_ST2084 :: SDLGPUSwapchainComposition
pattern SDL_GPU_SWAPCHAINCOMPOSITION_HDR10_ST2084 = SDLGPUSwapchainComposition #{const SDL_GPU_SWAPCHAINCOMPOSITION_HDR10_ST2084}
...
pattern SDL_PROP_GPU_COMPUTEPIPELINE_CREATE_NAME_STRING :: String
...
pattern SDL_PROP_GPU_GRAPHICSPIPELINE_CREATE_NAME_STRING :: String
...
pattern SDL_PROP_GPU_SAMPLER_CREATE_NAME_STRING :: String
...
pattern SDL_PROP_GPU_SHADER_CREATE_NAME_STRING :: String
...
pattern SDL_PROP_GPU_BUFFER_CREATE_NAME_STRING :: String
...
pattern SDL_PROP_GPU_TRANSFERBUFFER_CREATE_NAME_STRING :: String
