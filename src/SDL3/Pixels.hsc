...
--
-- /Since: 3.2.0/
pattern SDL_ALPHA_OPAQUE = (#{const SDL_ALPHA_OPAQUE}) :: Word8

-- | A fully opaque floating point alpha value.
--
-- /Since: 3.2.0/
pattern SDL_ALPHA_OPAQUE_FLOAT = (#{const SDL_ALPHA_OPAQUE_FLOAT}) :: Float

-- | A fully transparent 8-bit alpha value.
--
-- /Since: 3.2.0/
pattern SDL_ALPHA_TRANSPARENT = (#{const SDL_ALPHA_TRANSPARENT}) :: Word8

-- | A fully transparent floating point alpha value.
--
-- /Since: 3.2.0/
pattern SDL_ALPHA_TRANSPARENT_FLOAT = (#{const SDL_ALPHA_TRANSPARENT_FLOAT}) :: Float
