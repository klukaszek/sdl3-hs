...
import Data.Word
import SDL3.Atomic (SDLAtomicInt(..)) -- Assuming defined as newtype SDLAtomicInt (Ptr SDL_AtomicInt)
import SDL3.Properties (SDLPropertiesID)
import SDL3.Stdinc (SDLCall) -- Assuming defined as Ptr () or FunPtr
