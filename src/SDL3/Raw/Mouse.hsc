...
sdlSetRelativeMouseTransform :: FunPtr SDLMouseMotionTransformCallback -> Ptr () -> IO CBool
sdlSetRelativeMouseTransform = c_sdlSetRelativeMouseTransform
...
sdlCreateColorCursor :: Ptr SDLSurface -> Int -> Int -> IO (Maybe SDLCursor)
sdlCreateColorCursor surfacePtr hot_x hot_y = do
