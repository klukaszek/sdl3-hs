...
data SDLVirtualJoystickDesc = SDLVirtualJoystickDesc
  ...
  , virtualName         :: CString
  , virtualTouchpads    :: Ptr SDLVirtualJoystickTouchpadDesc
  , virtualSensors      :: Ptr SDLVirtualJoystickSensorDesc
  , virtualUserdata     :: Ptr ()
...
instance Storable SDLVirtualJoystickDesc where
  ...
  poke ptr (SDLVirtualJoystickDesc ver typ vid pid nax nbtn nball nhat ntouch nsens btnMask axisMask name touchpads sensors ud upd setPl rum rumTrig led eff sensEn clean) = do
    ...
    (#poke SDL_VirtualJoystickDesc, name) ptr name
    (#poke SDL_VirtualJoystickDesc, touchpads) ptr touchpads
    (#poke SDL_VirtualJoystickDesc, sensors) ptr sensors
