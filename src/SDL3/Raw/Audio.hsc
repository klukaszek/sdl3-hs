...
module SDL3.Raw.Audio
  ...
  , wrapAudioStreamCallback
  , wrapAudioPostmixCallback
...
sdlOpenAudioDeviceStream :: SDLAudioDeviceID -> Maybe SDLAudioSpec -> FunPtr SDLAudioStreamCallback -> Ptr () -> IO (Maybe SDLAudioStream)
sdlOpenAudioDeviceStream devid maybeSpec callbackPtr userdata =
...
sdlSetAudioPostmixCallback :: SDLAudioDeviceID -> FunPtr SDLAudioPostmixCallback -> Ptr () -> IO Bool
sdlSetAudioPostmixCallback devid callbackPtr userdata =
