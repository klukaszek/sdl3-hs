...
-- |
-- Module      : SDL3.Raw.Platform
-- Description : Raw SDL platform identification
-- Copyright   : (c) Kyle Lukaszek, 2025
-- License     : BSD3
--
-- Low-level platform identification bindings. Prefer 'SDL3.Wrapped.Platform'
-- or 'SDL3.Platform' unless you need direct FFI access.
