...
type SDLHintCallbackRaw = Ptr () -> CString -> CString -> CString -> IO ()

sdlSetHintWithPriority :: CString -> CString -> SDLHintPriority -> IO Bool
sdlSetHintWithPriority = sdlSetHintWithPriority_

sdlSetHint :: CString -> CString -> IO Bool
sdlSetHint = sdlSetHint_

sdlResetHint :: CString -> IO Bool
sdlResetHint = sdlResetHint_

sdlResetHints :: IO ()
sdlResetHints = sdlResetHints_

sdlGetHint :: CString -> IO CString
sdlGetHint = sdlGetHint_

sdlGetHintBoolean :: CString -> Bool -> IO Bool
sdlGetHintBoolean = sdlGetHintBoolean_

sdlAddHintCallback :: CString -> FunPtr SDLHintCallbackRaw -> Ptr () -> IO Bool
sdlAddHintCallback = sdlAddHintCallback_

sdlRemoveHintCallback :: CString -> FunPtr SDLHintCallbackRaw -> Ptr () -> IO ()
sdlRemoveHintCallback = sdlRemoveHintCallback_
