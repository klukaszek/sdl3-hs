...
import SDL3.Video (SDLWindow(..), SDLWindowID)
import SDL3.Mouse (SDLMouseID, SDLMouseButtonFlags)
import SDL3.Joystick (SDLJoystickID)
import SDL3.Gamepad (SDLGamepadButton)
import SDL3.Touch (SDLTouchID, SDLFingerID)
import SDL3.Pen (SDLPenID)
import SDL3.Keyboard (SDLKeyboardID)
