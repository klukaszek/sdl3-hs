...
createResources Context{ contextDevice = dev, contextWindow = win } = do
    ...
    let tex3DCI = SDLGPUTextureCreateInfo
    ...
    case maybeCmdbuf of
        ...
        Just cmdbuf -> do
            ...
            case maybeSwapchainResult of
                ...
                Just (swapchainTexture, w_uint32, h_uint32) -> do -- w, h are Word32
                    let w = fromIntegral w_uint32 :: Word32 -- Keep as Word32 for calculations
                    let h = fromIntegral h_uint32 :: Word32

                    -- Render to each layer of the 3D texture
                    let clearColors = [ SDLFColor 1 0 0 1 -- Red
                    ...
                    forM_ [0..3] $ \i_word32 -> do -- Use Word32 for layer index to match struct fields
                        ...
                        let srcRegion = SDLGPUBlitRegion
                        ...
                        let dstRegion = SDLGPUBlitRegion
