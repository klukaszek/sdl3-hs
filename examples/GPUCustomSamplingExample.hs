...
createResources Context{..} = do
    ...
    let fragShaderInfo = defaultShaderCreateInfo
            ...
            case maybeSurf of
                ...
                Just surfacePtr ->
                    ...
                    bracketOnError (pure surfacePtr) (\_ -> sdlDestroySurface surfacePtr) $ \surf -> do
                        ...
                        let textureCI = (defaultTextureCreateInfo imgW imgH)
                        ...
                        uploadSuccess <- bracket acquireUploadResources
                                    ...
                                    if mapOk1 && mapOk2 then do
                                        ...
                                        case mc of
                                            ...
                                            Just cp -> do
                                                ...
                                                let vbDst = SDLGPUBufferRegion vb 0 (fromIntegral vertexDataSizeBytes)
                                                ...
                                                let ibDst = SDLGPUBufferRegion ib 0 (fromIntegral indexDataSizeBytes)
                                                ...
                                                sdlSubmitGPUCommandBuffer cmdBuf >>= \s ->
                                                    if s then sdlWaitForGPUIdle contextDevice >> return True
