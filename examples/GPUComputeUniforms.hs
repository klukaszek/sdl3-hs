...
import SDL
import GPUCommon -- Import common setup, GradientUniforms, helpers

import Control.Monad (unless, when, void)
import Control.Exception (bracket, bracketOnError, finally)

import Foreign.Ptr (Ptr, castPtr)
import Foreign.Storable (Storable(..)) -- For Storable class constraints
import Foreign.C.Types (CFloat) -- For time type
                ...
                Just (w, h) -> do
                    ...
                    case maybeTexture of
                        ...
                        Just tex -> do
                            ...
                            return $ Just AppResources { resGradientPipeline = pipeline
